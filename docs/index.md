...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-newns-jul10](https://github.com/jdubrick-ai/test-newns-jul10)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-newns-jul10-gitops](https://github.com/jdubrick-ai/test-newns-jul10-gitops)

# **Usage**

To access the test-newns-jul10 application that was deployed using the Software Template, complete the following instructions:
